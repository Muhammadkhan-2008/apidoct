...
export const PLATFORMS: { value: Platform; label: string; url: string; keyless?: boolean }[] = [
  ...
  { value: 'deepseek', label: 'DeepSeek AI (V3/R1)', url: 'https://platform.deepseek.com/api_keys' },
  { value: 'moonshot', label: 'Moonshot Kimi', url: 'https://platform.moonshot.cn/console/api-keys' },
  ...
  { value: 'hyperbolic', label: 'Hyperbolic AI', url: 'https://app.hyperbolic.xyz' },
  { value: 'novita', label: 'Novita AI', url: 'https://novita.ai/settings/key-management' },
  { value: 'perplexity', label: 'Perplexity AI', url: 'https://www.perplexity.ai/settings/api' },
  { value: 'upstage', label: 'Upstage Solar', url: 'https://console.upstage.ai/api-keys' },
  { value: 'nebius', label: 'Nebius AI Studio', url: 'https://studio.nebius.ai' },
  { value: 'scaleway', label: 'Scaleway AI', url: 'https://console.scaleway.com' },
  { value: 'friendli', label: 'FriendliAI Suite', url: 'https://suite.friendli.ai' },
  { value: 'featherless', label: 'Featherless AI', url: 'https://featherless.ai' },
  { value: 'ai21', label: 'AI21 Labs', url: 'https://studio.ai21.com/account/api-key' },
  { value: 'baichuan', label: 'Baichuan AI', url: 'https://platform.baichuan-ai.com/console/apikey' },
  { value: 'yi', label: 'Yi (01.AI)', url: 'https://platform.lingyiwanwu.com/apikeys' },
  { value: 'minimax', label: 'MiniMax AI', url: 'https://platform.minimaxi.com' },
  { value: 'stepfun', label: 'StepFun AI', url: 'https://platform.stepfun.com' },
  { value: 'doubao', label: 'ByteDance Doubao', url: 'https://console.volcengine.com/ark' },
  { value: 'tavily', label: '🌐 Tavily Web Search API (Free Keys Pool)', url: 'https://tavily.com' },
  { value: 'serper', label: '🌐 Serper Web Search API (Free Keys Pool)', url: 'https://serper.dev' },
]
