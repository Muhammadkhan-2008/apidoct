...
function detectLocale(): Locale {
  ...
  const stored = window.localStorage.getItem('apidoct.locale') || window.localStorage.getItem('freellmapi.locale')
...
export function I18nProvider({ children, initialLocale }: I18nProviderProps) {
  ...
  useEffect(() => {
    window.localStorage.setItem('apidoct.locale', locale)
