...
export const openapiSpec = {
  ...
  info: {
    ...
    version: '0.4.1',
    description:
      'High-performance AI API Gateway & Management Suite that unifies model providers behind a single /v1 endpoint. ' +
      'Features intelligent request routing, automated failover, model fallback pools, and native multi-format support ' +
      'for OpenAI, Anthropic, Gemini, and Ollama APIs.',
    license: { name: 'MIT' },
  },
  servers: [
